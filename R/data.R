...
#' recodedgen is genetic data with 10 rows and 16 columns provided with the GARCOM package.
...
#' snpgene is SNP-gene annotation data provided with the GARCOM package with 10 rows and two columns. 
...
#' snppos SNP-BP data with 2 columns and 10 rows provided with the GARCOM package. Column names are SNP and BP. 
...
#' genecoord is Gene coordinate data with 3 columns and 5 rows provided with the GARCOM package. Column names are GENE, START and END
