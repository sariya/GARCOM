...
#' snpgene is SNP-gene annotation data with 10 rows and two columns. 
...
#' snppos SNP-BP data with 2 columns and 10 rows. Column names are SNP and BP. 
...
#' genecoord is Gene coordinate data with 3 columns and 5 rows. Column names are GENE, START and END
